...
export function SoftGateModal({ isOpen, onClose }: SoftGateModalProps) {
  ...
  return (
    ...
    >
      <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-[#FDFBF7] p-6 sm:p-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex flex-col rounded-lg border border-[#333333] p-5">
            ...
            <button
              ...
              className="mt-auto rounded-full border border-[#333333] px-4 py-2 text-sm font-medium text-[#14211D] transition-colors duration-150 hover:bg-[#F5F2EA] disabled:opacity-50"
            >
          ...
          >
            ...
            <button
              ...
              className="mt-auto rounded-full bg-[#C5A059] px-4 py-3 text-sm font-bold text-black transition-shadow duration-150 hover:shadow-[0_0_16px_rgba(197,160,89,0.6)] disabled:opacity-50"
            >
